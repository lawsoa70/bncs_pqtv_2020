...
public:
	...
	BOOL setSourceSncsLabel( int iSourceNumber, bncs_string ssSncsLabel );
	bncs_string getSourceSncsLabel( int iSourceNumber );

	BOOL getAllSncsLabelData( int iIndex, bncs_string *szAlias, bncs_string *szSNCSName, 
									 bncs_string *iPermStatus, bncs_stringlist *sslist );  // locate by index number
	
	BOOL getAllSncsLabelData( bncs_string szAlias, int *iIndex, bncs_string *szSNCSName, 
								    bncs_string *iPermStatus, bncs_stringlist *sslist ); // locate by alias name
	...
	BOOL getAllRouterLabelData( int iSourceNum, bncs_string *szAutoName, bncs_string *szManlName,
									bncs_string *iAutoStatus, bncs_string *iPermStatus, bncs_string *ssLabel );  // locate by source number

	int findNextFreeIndex( bncs_string ssNewLabel );
